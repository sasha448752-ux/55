...
create table public.orders (
  ...
  price_kop integer not null, photo_path text not null, crop_position jsonb not null default '{"x":50,"y":50}'::jsonb, photo_effect text not null default 'none' check (photo_effect in ('none','black_white','warm','vintage','contrast')), account_claim_token uuid unique, telegram_notified_at timestamptz,
